...
object Versions {
    ...
    const val butterknifeSdkVersion = "10.2.1"
...
object Depend {
    ...
    const val refreshKernel = "com.scwang.smart:refresh-layout-kernel:2.0.1"
    const val refreshClassics = "com.scwang.smart:refresh-header-classics:2.0.1"

    //rx1
    const val rxandroid = "io.reactivex.rxjava2:rxandroid:2.0.2"
    const val rxjava = "io.reactivex.rxjava2:rxjava:2.1.17"
    ...
    const val rxcacheJolyglotGson = "com.github.VictorAlbertos.Jolyglot:gson:0.0.4"
    ...
    //tools
    const val dagger2 = "com.google.dagger:dagger:${Versions.dagger2SdkVersion}"
    ...
    const val dagger2Compiler = "com.google.dagger:dagger-compiler:${Versions.dagger2SdkVersion}"
    ...
    const val espressoCore = "com.android.support.test.espresso:espresso-core:${Versions.espressoSdkVersion}"
